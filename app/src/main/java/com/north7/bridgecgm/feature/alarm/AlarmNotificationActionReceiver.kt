...
class AlarmNotificationActionReceiver : BroadcastReceiver() {
    ...
    companion object {
        ...
        const val ACTION_SNOOZE = "com.north7.bridgecgm.action.ALARM_SNOOZE"
        const val ACTION_DISMISS_AND_SNOOZE = "com.north7.bridgecgm.action.ALARM_DISMISS_AND_SNOOZE"
        const val ACTION_OPEN_SETTINGS = "com.north7.bridgecgm.action.ALARM_OPEN_SETTINGS"
    }
}
