...
class GlucoseMarkerView(
    ...
    override fun refreshContent(e: Entry?, highlight: Highlight?) {
        ...
        tvValue.text = if (outputUnit == "mmol") {
            String.format(Locale.US, "%.1f mmol/L", mgdl / com.north7.bridgecgm.core.constants.GlucoseConstants.MMOL_FACTOR)
        } else {
            "$mgdl mg/dL"
        }
        ...
        // Color by range
        val color = when {
            mgdl < com.north7.bridgecgm.core.constants.GlucoseConstants.LOW_DEFAULT_MGDL -> COLOR_LOW
            mgdl <= com.north7.bridgecgm.core.constants.GlucoseConstants.HIGH_DEFAULT_MGDL -> COLOR_IN_RANGE
            else        -> COLOR_HIGH
        }
